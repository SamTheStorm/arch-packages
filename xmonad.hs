...
myKeys c =
  ...
  , ("M-S-<Return>", addName "Run prompt"      $ sequence_ [spawn (mySoundPlayer ++ dmenuSound), spawn "rofi -show combi -combi-modi window,run,ssh,windowcd,drun,keys,filebrowser -modi combi"])
  , ("M-/", addName "DTOS Help"                $ spawn "dtos-help")
  , ("C-<Tab>", addName "Rofi"                 $ spawn "rofi -modi window,run,ssh,windowcd,drun,combi,keys,filebrowser,calc -show window")]
